...
FVDB_CORE_NIGHTLY_CUDA_SUFFIX="${FVDB_VIZ_CORE_NIGHTLY_CUDA_SUFFIX:-${FVDB_VIZ_CORE_VERSION_DEFAULT#*+}}"
...
IMAGE_NAME="${FVDB_VIZ_TEST_IMAGE:-nanovdb-editor_fvdb-${CORE_SOURCE_TAG}}"
