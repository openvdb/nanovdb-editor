...
if [[ -z "${FVDB_VIZ_TEST_IMAGE:-}" ]]; then
  FVDB_VIZ_TEST_IMAGE="nanovdb-editor_fvdb-${CORE_SOURCE_TAG}"
fi
...
DOCKER_RUN_COMMON=(
  ...
  -e "FVDB_VIZ_PREFLIGHT_TIMEOUT_SECONDS=${FVDB_VIZ_PREFLIGHT_TIMEOUT_SECONDS:-120}"
  -e "FVDB_VIZ_SUITE_TIMEOUT_SECONDS=${FVDB_VIZ_SUITE_TIMEOUT_SECONDS:-300}"
