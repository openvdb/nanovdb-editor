...
LOCAL_MANYLINUX_X86_64_TAG="${LOCAL_MANYLINUX_X86_64_TAG:-manylinux_2_27_x86_64}"
LOCAL_MANYLINUX_X86_64_IMAGE="${LOCAL_MANYLINUX_X86_64_IMAGE:-quay.io/pypa/manylinux_2_28_x86_64:latest}"
...
CIBW_ENVIRONMENT_VALUE="CMAKE_ARGS=\"${CMAKE_ARGS_VALUE}\" CPM_SOURCE_CACHE=/tmp/cpm-cache LOCAL_MANYLINUX_X86_64_TAG=${LOCAL_MANYLINUX_X86_64_TAG}"
...
if [ -n "${LOCAL_SLANG_IMAGE_REF}" ]; then
  ...
  CIBW_ENVIRONMENT_VALUE="CMAKE_ARGS=\"${CMAKE_ARGS_VALUE}\" CPM_SOURCE_CACHE=/tmp/cpm-cache LOCAL_MANYLINUX_X86_64_TAG=${LOCAL_MANYLINUX_X86_64_TAG} NANOVDB_SLANG_IMAGE_LIB_DIR=${LOCAL_SLANG_IMAGE_CONTAINER_LIB_DIR}"
fi
