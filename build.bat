...
if "%USE_VCPKG%"=="ON" (
    ...
    set "CMAKE_ARGS=-DCMAKE_TOOLCHAIN_FILE=%PY_VCPKG_CMAKE% -DCMAKE_PREFIX_PATH=%PY_VCPKG_PREFIX_PATH% -DVCPKG_INSTALLED_DIR=%PY_VCPKG_INSTALLED_DIR% -DNANOVDB_EDITOR_USE_VCPKG=ON"
) else (
    set "CMAKE_ARGS="
)
