...
typedef struct pnanovdb_imgui_renderer_interface_t
{
    ...
    pnanovdb_imgui_renderer_t*(PNANOVDB_ABI* create)(const pnanovdb_compute_t* compute,
    ...
    void(PNANOVDB_ABI* render)(const pnanovdb_compute_t* compute,
    ...
    void(PNANOVDB_ABI* copy_texture)(const pnanovdb_compute_t* compute,
                                     pnanovdb_compute_context_t* context,
                                     pnanovdb_imgui_renderer_t* renderer,
                                     pnanovdb_uint32_t width,
                                     pnanovdb_uint32_t height,
    ...
    void(PNANOVDB_ABI* copy_texture_yuv)(const pnanovdb_compute_t* compute,
                                         pnanovdb_compute_context_t* context,
                                         pnanovdb_imgui_renderer_t* renderer,
                                         pnanovdb_uint32_t width,
                                         pnanovdb_uint32_t height,
    ...
    pnanovdb_imgui_texture_t*(PNANOVDB_ABI* create_texture)(pnanovdb_compute_context_t* context,
                                                            pnanovdb_imgui_renderer_t* renderer,
                                                            unsigned char* pixels,
                                                            int texWidth,
                                                            int texHeight);

    void(PNANOVDB_ABI* update_texture)(pnanovdb_compute_context_t* context,
                                       pnanovdb_imgui_renderer_t* renderer,
...
PNANOVDB_REFLECT_FUNCTION_POINTER(copy_texture_yuv, 0, 0)
