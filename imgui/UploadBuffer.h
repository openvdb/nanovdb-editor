...
PNANOVDB_INLINE void pnanovdb_compute_dispatch_batches_init_custom(pnanovdb_compute_dispatch_batches_t* ptr,
...
PNANOVDB_INLINE void pnanovdb_compute_dispatch_batches_init(pnanovdb_compute_dispatch_batches_t* ptr,
                                                            pnanovdb_uint32_t total_block_count)
{
...
PNANOVDB_INLINE pnanovdb_uint64_t pnanovdb_compute_buffer_versioning_map(pnanovdb_compute_buffer_versioning_t* ptr,
...
PNANOVDB_INLINE void pnanovdb_compute_buffer_versioning_unmap(pnanovdb_compute_buffer_versioning_t* ptr,
...
PNANOVDB_INLINE void pnanovdb_compute_upload_buffer_copy_buffer(pnanovdb_compute_context_t* context,
                                                                const pnanovdb_compute_copy_buffer_params_t* params,
                                                                void* userdata)
{
    pnanovdb_compute_upload_buffer_t* ptr = (pnanovdb_compute_upload_buffer_t*)userdata;
...
PNANOVDB_INLINE void pnanovdb_compute_upload_buffer_init(pnanovdb_compute_interface_t* compute_interface,
                                                         pnanovdb_compute_context_t* context,
                                                         pnanovdb_compute_upload_buffer_t* ptr,
                                                         pnanovdb_compute_buffer_usage_t usage,
                                                         pnanovdb_compute_format_t format,
                                                         pnanovdb_uint32_t structure_stride)
{
    pnanovdb_compute_upload_buffer_init_custom(compute_interface, context, ptr, usage, format, structure_stride,
                                               pnanovdb_compute_upload_buffer_create_buffer,
                                               pnanovdb_compute_upload_buffer_copy_buffer, ptr);
}

PNANOVDB_INLINE void pnanovdb_compute_upload_buffer_destroy(pnanovdb_compute_context_t* context,
                                                            pnanovdb_compute_upload_buffer_t* ptr)
{
...
PNANOVDB_INLINE void* pnanovdb_compute_upload_buffer_map(pnanovdb_compute_context_t* context,
                                                         pnanovdb_compute_upload_buffer_t* ptr,
                                                         pnanovdb_uint64_t num_bytes)
{
    ...
    pnanovdb_uint64_t instance_idx =
        pnanovdb_compute_buffer_versioning_map(&ptr->versioning, frame_info.frame_local_completed);
...
PNANOVDB_INLINE pnanovdb_compute_buffer_transient_t* pnanovdb_compute_upload_buffer_get_device(
    pnanovdb_compute_context_t* context, pnanovdb_compute_upload_buffer_t* ptr, pnanovdb_uint64_t num_bytes)
{
    pnanovdb_compute_frame_info_t frame_info = {};
    ptr->compute_interface->get_frame_info(context, &frame_info);
    ...
    if (ptr->device_buffer_transient && ptr->device_buffer_transient_frame == frame_info.frame_local_current)
    {
