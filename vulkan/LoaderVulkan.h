...
#define PNANOVDB_VK_LOADER_PTR(FUNC_REF) PFN_##FUNC_REF FUNC_REF = nullptr

#define PNANOVDB_VK_LOADER_INSTANCE(X) ptr->X = (PFN_##X)ptr->vkGetInstanceProcAddr(vulkanInstance, #X)

#define PNANOVDB_VK_LOADER_DEVICE(X) ptr->X = (PFN_##X)ptr->vkGetDeviceProcAddr(vulkanDevice, #X)
...
typedef struct pnanovdb_vulkan_instance_loader_t
{
    ...
    PNANOVDB_VK_LOADER_PTR(vkEnumerateInstanceVersion);
    ...
    PNANOVDB_VK_LOADER_PTR(vkGetPhysicalDeviceVideoCapabilitiesKHR);
    PNANOVDB_VK_LOADER_PTR(vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR);
    PNANOVDB_VK_LOADER_PTR(vkGetPhysicalDeviceVideoFormatPropertiesKHR);
...
typedef struct pnanovdb_vulkan_device_loader_t
{
    ...
    PNANOVDB_VK_LOADER_PTR(vkCreateVideoSessionKHR);
    PNANOVDB_VK_LOADER_PTR(vkGetVideoSessionMemoryRequirementsKHR);
    PNANOVDB_VK_LOADER_PTR(vkBindVideoSessionMemoryKHR);
    PNANOVDB_VK_LOADER_PTR(vkCreateVideoSessionParametersKHR);
    PNANOVDB_VK_LOADER_PTR(vkGetEncodedVideoSessionParametersKHR);
    PNANOVDB_VK_LOADER_PTR(vkCmdBeginVideoCodingKHR);
    PNANOVDB_VK_LOADER_PTR(vkCmdControlVideoCodingKHR);
    PNANOVDB_VK_LOADER_PTR(vkCmdEndVideoCodingKHR);
    PNANOVDB_VK_LOADER_PTR(vkCmdPipelineBarrier2);
    PNANOVDB_VK_LOADER_PTR(vkCmdBeginQuery);
    PNANOVDB_VK_LOADER_PTR(vkCmdEncodeVideoKHR);
    PNANOVDB_VK_LOADER_PTR(vkCmdEndQuery);
                                                   ...
                                                   PFN_vkGetInstanceProcAddr getInstanceProcAddr)
{
    ...
    PNANOVDB_VK_LOADER_INSTANCE(vkEnumerateInstanceVersion);
}
...
PNANOVDB_INLINE void pnanovdb_vulkan_loader_instance(pnanovdb_vulkan_instance_loader_t* ptr, VkInstance vulkanInstance)
{
    ...
    PNANOVDB_VK_LOADER_INSTANCE(vkGetPhysicalDeviceVideoCapabilitiesKHR);
    PNANOVDB_VK_LOADER_INSTANCE(vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR);
    PNANOVDB_VK_LOADER_INSTANCE(vkGetPhysicalDeviceVideoFormatPropertiesKHR);
}

PNANOVDB_INLINE void pnanovdb_vulkan_loader_device(pnanovdb_vulkan_device_loader_t* ptr,
                                                   ...
                                                   PFN_vkGetDeviceProcAddr getDeviceProcAddr)
{
    ...
    PNANOVDB_VK_LOADER_DEVICE(vkCreateVideoSessionKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkGetVideoSessionMemoryRequirementsKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkBindVideoSessionMemoryKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkCreateVideoSessionParametersKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkGetEncodedVideoSessionParametersKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkCmdBeginVideoCodingKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkCmdControlVideoCodingKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkCmdEndVideoCodingKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkCmdPipelineBarrier2);
    PNANOVDB_VK_LOADER_DEVICE(vkCmdBeginQuery);
    PNANOVDB_VK_LOADER_DEVICE(vkCmdEncodeVideoKHR);
    PNANOVDB_VK_LOADER_DEVICE(vkCmdEndQuery);
