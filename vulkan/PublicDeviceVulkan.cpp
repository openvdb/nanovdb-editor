...
void execute_tasks(pnanovdb_compute_context_t* context,
                   pnanovdb_uint32_t taskCount,
                   pnanovdb_uint32_t taskGranularity,
...
pnanovdb_compute_device_interface_t* pnanovdb_get_compute_device_interface(pnanovdb_compute_api_t api)
{
    ...
    using namespace pnanovdb_vulkan;
    static pnanovdb_compute_device_interface_t iface = { PNANOVDB_REFLECT_INTERFACE_INIT(
    ...
    iface.create_encoder = create_encoder;
    iface.destroy_encoder = destroy_encoder;
    iface.present_encoder = present_encoder;
    iface.get_encoder_front_texture = get_encoder_front_texture;
    iface.map_encoder_data = map_encoder_data;
    iface.unmap_encoder_data = unmap_encoder_data;
