...
PNANOVDB_CAST_PAIR(pnanovdb_compute_encoder_t, Encoder)
...
struct DeviceManager
{
    ...
    pnanovdb_bool_t instanceSupportsVulkanVideo = PNANOVDB_FALSE;
    uint32_t vulkanInstanceVersion = 0u;
};
...
pnanovdb_compute_device_t* createDevice(pnanovdb_compute_device_manager_t* deviceManager,
...
struct DeviceQueue
{
    ...
    VkSemaphore beginFrameSemaphore[kMaxFramesInFlight] = { VK_NULL_HANDLE };
    VkSemaphore endFrameSemaphore[kMaxFramesInFlight] = { VK_NULL_HANDLE };
...
int flush(pnanovdb_compute_queue_t* ptr,
...
int flushStepA(DeviceQueue* ptr,
               pnanovdb_compute_semaphore_t* waitSemaphore,
               pnanovdb_compute_semaphore_t* signalSemaphore);
...
struct Encoder
{
    ...
    VkVideoEncodeRateControlLayerInfoKHR encodeRateControlLayerInfo;
    VkVideoEncodeH264RateControlInfoKHR encodeH264RateControlInfo;
    VkVideoEncodeRateControlInfoKHR encodeRateControlInfo;

    VkVideoEncodeRateControlModeFlagBitsKHR chosenRateControlMode;

    std::vector<VkDeviceMemory> memories;

    std::vector<char> bitStreamHeader;
    std::vector<char> bitStreamTmp;

    VkBuffer bitStreamBuffer;
    VkDeviceMemory bitStreamMemory;
    uint8_t* bitStreamData;

    VkImage dpbImages[2];
    VkDeviceMemory dpbMemories[2];
    VkImageView dpbImageViews[2];

    VkImage srcImage;
    VkDeviceMemory srcMemory;
    pnanovdb_compute_texture_t* srcTexture;

    VkQueryPool queryPool;

    VkFence encodeFinishedFence;

    pnanovdb_uint32_t frameCount;
};
...
pnanovdb_compute_buffer_t* createBuffer(pnanovdb_compute_context_t* context,
...
pnanovdb_compute_buffer_transient_t* getBufferTransient(pnanovdb_compute_context_t* context,
                                                        const pnanovdb_compute_buffer_desc_t* desc);
pnanovdb_compute_buffer_transient_t* registerBufferAsTransient(pnanovdb_compute_context_t* context,
                                                               pnanovdb_compute_buffer_t* buffer);
pnanovdb_compute_buffer_transient_t* aliasBufferTransient(pnanovdb_compute_context_t* context,
                                                          pnanovdb_compute_buffer_transient_t* buffer,
                                                          pnanovdb_compute_format_t format,
                                                          pnanovdb_uint32_t structureStride);
pnanovdb_compute_buffer_acquire_t* enqueueAcquireBuffer(pnanovdb_compute_context_t* context,
                                                        pnanovdb_compute_buffer_transient_t* buffer);
pnanovdb_bool_t getAcquiredBuffer(pnanovdb_compute_context_t* context,
...
void getBufferExternalHandle(pnanovdb_compute_context_t* context,
                             pnanovdb_compute_buffer_t* buffer,
                             pnanovdb_compute_interop_handle_t* dstHandle);
void closeBufferExternalHandle(pnanovdb_compute_context_t* context,
                               pnanovdb_compute_buffer_t* buffer,
                               const pnanovdb_compute_interop_handle_t* srcHandle);
pnanovdb_compute_buffer_t* createBufferFromExternalHandle(pnanovdb_compute_context_t* context,
                                                          const pnanovdb_compute_buffer_desc_t* desc,
                                                          const pnanovdb_compute_interop_handle_t* interopHandle);
void device_getBufferExternalHandle(pnanovdb_compute_context_t* context,
                                    pnanovdb_compute_buffer_t* buffer,
                                    void* dstHandle,
                                    pnanovdb_uint64_t dstHandleSize,
                                    pnanovdb_uint64_t* pBufferSizeInBytes);
void device_closeBufferExternalHandle(pnanovdb_compute_context_t* context,
                                      pnanovdb_compute_buffer_t* buffer,
                                      const void* srcHandle,
                                      pnanovdb_uint64_t srcHandleSize);

Buffer* buffer_create(Context* context,
                      pnanovdb_compute_memory_type_t memory_type,
                      const pnanovdb_compute_buffer_desc_t* desc,
                      const pnanovdb_compute_interop_handle_t* interopHandle);
...
struct Texture
{
    ...
    std::vector<pnanovdb_compute_format_t> aliasFormats;
    std::vector<pnanovdb_compute_texture_aspect_t> aliasAspects;
...
struct TextureTransient
{
    ...
    pnanovdb_compute_format_t aliasFormat = PNANOVDB_COMPUTE_FORMAT_UNKNOWN;
    pnanovdb_compute_texture_aspect_t aliasAspect = PNANOVDB_COMPUTE_TEXTURE_ASPECT_NONE;
    int nodeBegin = 0;
    int nodeEnd = 0;
};
...
pnanovdb_compute_texture_t* createTexture(pnanovdb_compute_context_t* context,
                                          const pnanovdb_compute_texture_desc_t* desc);
pnanovdb_compute_texture_t* createTextureExternal(pnanovdb_compute_context_t* context,
                                                  const pnanovdb_compute_texture_desc_t* desc,
                                                  VkImage externalImage,
                                                  VkImageLayout defaultLayout);
void destroyTexture(pnanovdb_compute_context_t* context, pnanovdb_compute_texture_t* texture);
pnanovdb_compute_texture_transient_t* getTextureTransient(pnanovdb_compute_context_t* context,
                                                          const pnanovdb_compute_texture_desc_t* desc);
pnanovdb_compute_texture_transient_t* registerTextureAsTransient(pnanovdb_compute_context_t* context,
                                                                 pnanovdb_compute_texture_t* texture);
pnanovdb_compute_texture_transient_t* aliasTextureTransient(pnanovdb_compute_context_t* context,
                                                            pnanovdb_compute_texture_transient_t* texture,
                                                            pnanovdb_compute_format_t format,
                                                            pnanovdb_compute_texture_aspect_t aspect);
pnanovdb_compute_texture_acquire_t* enqueueAcquireTexture(pnanovdb_compute_context_t* context,
                                                          pnanovdb_compute_texture_transient_t* texture);
pnanovdb_bool_t getAcquiredTexture(pnanovdb_compute_context_t* context,
...
Texture* texture_createExternal(Context* context,
                                const pnanovdb_compute_texture_desc_t* desc,
                                VkImage externalImage,
                                VkImageLayout defaultLayout);
void texture_destroy(Context* context, Texture* texture);
void context_destroyTextures(Context* context);
VkImageView texture_getImageViewAll(Context* context,
                                    Texture* ptr,
                                    pnanovdb_compute_format_t aliasFormat,
                                    pnanovdb_compute_texture_aspect_t aliasAspect);
VkImageView texture_getImageViewMipLevel(Context* context,
                                         Texture* ptr,
                                         pnanovdb_compute_format_t aliasFormat,
                                         pnanovdb_compute_texture_aspect_t aliasAspect);
...
pnanovdb_compute_sampler_t* createSampler(pnanovdb_compute_context_t* context,
...
pnanovdb_compute_pipeline_t* createComputePipeline(pnanovdb_compute_context_t* context,
...
void computePipeline_destroy(Context* context, pnanovdb_compute_pipeline_t* pipeline);
void context_destroyComputePipelines(Context* context);
...
void profilerCapture_reset(Context* context,
                           ProfilerCapture* ptr,
                           pnanovdb_uint64_t minCapacity,
...
pnanovdb_bool_t profilerCapture_mapResults(Context* context,
                                           ProfilerCapture* ptr,
                                           pnanovdb_uint64_t* pNumEntries,
                                           pnanovdb_compute_profiler_entry_t** pEntries);
...
struct Profiler
{
    ...
    void(PNANOVDB_ABI* reportEntries)(void* userdata,
                                      pnanovdb_uint64_t captureID,
...
void enableProfiler(pnanovdb_compute_context_t* context,
                    void* userdata,
                    void(PNANOVDB_ABI* reportEntries)(void* userdata,
                                                      pnanovdb_uint64_t captureID,
                                                      pnanovdb_uint32_t numEntries,
...
struct Context
{
    ...
    std::vector<pnanovdb_compute_pipeline_t*> deferredReleasePipelines;
...
void determineMatches(std::vector<const char*>& extensionsEnabled,
                      std::vector<ExtensionRequest>& extensionsRequest,
                      std::vector<VkExtensionProperties>& extensions);

void selectInstanceExtensions(DeviceManager* ptr, std::vector<const char*>& instanceExtensionsEnabled);

void selectDeviceExtensions(Device* ptr,
                            std::vector<const char*>& deviceExtensionsEnabled,
                            pnanovdb_bool_t instanceSupportsVulkanVideo);
}
