...
/*!
    \file   nanovdb_editor/editor/PrintSlice.cpp
...
void test_pnanovdb_io_copy_subregion(pnanovdb_io_buf_t* src_nanovdb,
                                     pnanovdb_io_buf_t* dst_nanovdb,
                                     ...
                                     pnanovdb_coord_t ijk_max)
{
    ...
    pnanovdb_io_copy_subregion(
        src_nanovdb, pnanovdb_io_fread_fileheader(src_nanovdb, 0, 0, 0), dst_nanovdb, dst_grid, ijk_min, ijk_max);
}
