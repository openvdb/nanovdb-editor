...
/*!
    \file   nanovdb_editor/raster/Sphere.h
...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_read_uint32_index(pnanovdb_buf_t buf,
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_write_uint32_index(pnanovdb_buf_t buf,
                                                             pnanovdb_address_t addr,
                                                             pnanovdb_uint64_t index,
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_init_grid(pnanovdb_buf_t buf, pnanovdb_uint32_t empty_grid_size, float voxel_size)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_int32_t pnanovdb_sphere_box_overlap(pnanovdb_coord_t ijk_box_min,
                                                                   pnanovdb_coord_t ijk_box_max,
                                                                   float radius)
{
    pnanovdb_vec3_t box_min = { pnanovdb_int32_to_float(ijk_box_min.x), pnanovdb_int32_to_float(ijk_box_min.y),
                                pnanovdb_int32_to_float(ijk_box_min.z) };
    pnanovdb_vec3_t box_max = { pnanovdb_int32_to_float(ijk_box_max.x), pnanovdb_int32_to_float(ijk_box_max.y),
...
PNANOVDB_FORCE_INLINE pnanovdb_coord_t pnanovdb_node2_fastroot_ijk_wrap(pnanovdb_uint32_t node_type,
                                                                        pnanovdb_coord_t ijk_in)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_estimate_child_capacity(pnanovdb_buf_t buf,
...
PNANOVDB_FORCE_INLINE pnanovdb_node2_handle_t pnanovdb_node2_generate_sphere_node(pnanovdb_buf_t buf,
                                                                                  ...
                                                                                  PNANOVDB_INOUT(pnanovdb_coord_t)
                                                                                      out_ijk,
                                                                                  PNANOVDB_INOUT(pnanovdb_address_t)
                                                                                      addr_end,
                                                                                      ...
                                                                                      node_idx)
{
    ...
    if (n_in == 0)
    {
        ...
        for (pnanovdb_uint32_t idx = 0u; idx < value_level_count; idx++)
        {
            ...
            pnanovdb_uint64_t value_level_word =
                pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_value_level + (idx >> 4u));
    ...
    if (overlap == -1) // fully inside, add tile value
    {
        pnanovdb_uint64_t mask =
            pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_value_mask[node_type] + (n >> 6u));
    ...
    {
        pnanovdb_uint64_t mask =
            pnanovdb_node2_read(buf, node.idx64 + pnanovdb_node2_off_child_mask[node_type] + (n >> 6u));
        pnanovdb_uint64_t mask_old = mask;
        mask |= (1llu << (n & 63));
        ...
        if (mask != mask_old)
        {
            ...
            pnanovdb_uint32_t child_child_cap =
                pnanovdb_node2_estimate_child_capacity(buf, child_type, voxel_radius, ijk_min);
...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_node2_compute_active_values_word_count(pnanovdb_buf_t buf,
                                                                                        pnanovdb_node2_handle_t node,
                                                                                        pnanovdb_uint32_t node_type)
{
...
PNANOVDB_FORCE_INLINE void pnanovdb_node2_generate_sphere(pnanovdb_buf_t buf,
                                                          pnanovdb_address_t addr_max,
                                                          float voxel_size,
                                                          float radius)
{
    ...
    for (pnanovdb_uint32_t depth = 0u; depth < 4u; depth++)
    {
        ...
        for (pnanovdb_uint32_t root_n = 0u; root_n < root_fanout; root_n++)
        {
            ...
            pnanovdb_node2_handle_t upper = pnanovdb_node2_generate_sphere_node(
                buf, addr_max, PNANOVDB_NODE2_TYPE_ROOT, PNANOVDB_NODE2_TYPE_UPPER, voxel_radius, root, root_ijk,
                root_n, PNANOVDB_REF(upper_ijk), PNANOVDB_REF(addr_end), PNANOVDB_REF(node_idx));
            ...
            if (depth >= 1u && upper.idx64 != 0u)
            {
                ...
                for (pnanovdb_uint32_t upper_n = 0u; upper_n < upper_fanout; upper_n++)
                {
                    ...
                    pnanovdb_node2_handle_t lower = pnanovdb_node2_generate_sphere_node(
                        buf, addr_max, PNANOVDB_NODE2_TYPE_UPPER, PNANOVDB_NODE2_TYPE_LOWER, voxel_radius, upper,
                        upper_ijk, upper_n, PNANOVDB_REF(lower_ijk), PNANOVDB_REF(addr_end), PNANOVDB_REF(node_idx));
                    ...
                    if (depth >= 2u && lower.idx64 != 0u)
                    {
                        ...
                        for (pnanovdb_uint32_t lower_n = 0u; lower_n < lower_fanout; lower_n++)
                        {
                            ...
                            pnanovdb_node2_handle_t leaf = pnanovdb_node2_generate_sphere_node(
                                buf, addr_max, PNANOVDB_NODE2_TYPE_LOWER, PNANOVDB_NODE2_TYPE_LEAF, voxel_radius, lower,
                                lower_ijk, lower_n, PNANOVDB_REF(leaf_ijk), PNANOVDB_REF(addr_end),
                            ...
                            if (depth >= 3u && leaf.idx64 != 0u)
                            {
                                ...
                                for (pnanovdb_uint32_t leaf_n = 0u; leaf_n < leaf_fanout; leaf_n++)
                                {
                                    ...
                                    pnanovdb_node2_generate_sphere_node(buf, addr_max, PNANOVDB_NODE2_TYPE_LEAF,
                                                                        PNANOVDB_NODE2_TYPE_LEAF, voxel_radius, leaf,
                                                                        leaf_ijk, leaf_n, PNANOVDB_REF(voxel_ijk),
                                                                        PNANOVDB_REF(addr_end), PNANOVDB_REF(node_idx));
                                }
                            }
                        }
                    }
    ...
    value_count = pnanovdb_uint64_offset(
        value_count, pnanovdb_node2_compute_active_values_word_count(buf, root, PNANOVDB_NODE2_TYPE_ROOT));
    ...
    for (pnanovdb_uint32_t root_n = 0u; root_n < root_fanout; root_n++)
    {
        ...
        value_count = pnanovdb_uint64_offset(
            value_count, pnanovdb_node2_compute_active_values_word_count(buf, upper, PNANOVDB_NODE2_TYPE_UPPER));
        ...
        for (pnanovdb_uint32_t upper_n = 0u; upper_n < node2_upper_fanout; upper_n++)
        {
            ...
            value_count = pnanovdb_uint64_offset(
                value_count, pnanovdb_node2_compute_active_values_word_count(buf, lower, PNANOVDB_NODE2_TYPE_LOWER));
            ...
            for (pnanovdb_uint32_t lower_n = 0u; lower_n < node2_lower_fanout; lower_n++)
            {
                ...
                value_count = pnanovdb_uint64_offset(
                    value_count, pnanovdb_node2_compute_active_values_word_count(buf, leaf, PNANOVDB_NODE2_TYPE_LEAF));
            }
        }
    }
    ...
    // write root bbox
    pnanovdb_coord_t root_bbox_min = { pnanovdb_float_to_int32(pnanovdb_floor(-voxel_radius)),
                                       pnanovdb_float_to_int32(pnanovdb_floor(-voxel_radius)),
                                       pnanovdb_float_to_int32(pnanovdb_floor(-voxel_radius)) };
    pnanovdb_coord_t root_bbox_max = { pnanovdb_float_to_int32(-pnanovdb_floor(-voxel_radius)),
                                       pnanovdb_float_to_int32(-pnanovdb_floor(-voxel_radius)),
                                       pnanovdb_float_to_int32(-pnanovdb_floor(-voxel_radius)) };
    ...
    for (pnanovdb_uint32_t root_n = 0u; root_n < root_fanout; root_n++)
    {
        ...
        {
            pnanovdb_uint64_t value_idx =
                pnanovdb_node2_get_value_index(buf, root, PNANOVDB_NODE2_TYPE_ROOT, root_n, PNANOVDB_FALSE,
                                               pnanovdb_address_null(), pnanovdb_address_null());
        ...
        for (pnanovdb_uint32_t upper_n = 0u; upper_n < node2_upper_fanout; upper_n++)
        {
            ...
            {
                pnanovdb_uint64_t value_idx =
                    pnanovdb_node2_get_value_index(buf, upper, PNANOVDB_NODE2_TYPE_UPPER, upper_n, PNANOVDB_FALSE,
                                                   pnanovdb_address_null(), pnanovdb_address_null());
                pnanovdb_uint32_t value_level = 0u;
                pnanovdb_node2_adaptive_n(buf, upper, PNANOVDB_NODE2_TYPE_UPPER, upper_n, PNANOVDB_REF(value_level));
                pnanovdb_node2_write_uint32_index(
                    buf, values, value_idx, pnanovdb_node2_value_level_to_rgba(value_level));
            }
            pnanovdb_node2_handle_t lower = pnanovdb_node2_get_child(buf, upper, PNANOVDB_NODE2_TYPE_UPPER, upper_n);
            if (lower.idx64 == 0u)
            {
            ...
            for (pnanovdb_uint32_t lower_n = 0u; lower_n < node2_lower_fanout; lower_n++)
            {
                ...
                {
                    pnanovdb_uint64_t value_idx =
                        pnanovdb_node2_get_value_index(buf, lower, PNANOVDB_NODE2_TYPE_LOWER, lower_n, PNANOVDB_FALSE,
                                                       pnanovdb_address_null(), pnanovdb_address_null());
                    pnanovdb_uint32_t value_level = 0u;
                ...
                for (pnanovdb_uint32_t leaf_n = 0u; leaf_n < node2_leaf_fanout; leaf_n++)
                {
                    ...
                    {
                        pnanovdb_uint64_t value_idx =
                            pnanovdb_node2_get_value_index(buf, leaf, PNANOVDB_NODE2_TYPE_LEAF, leaf_n, PNANOVDB_FALSE,
                                                           pnanovdb_address_null(), pnanovdb_address_null());
                        pnanovdb_uint32_t value_level = 0u;
