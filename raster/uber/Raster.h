...
PNANOVDB_FORCE_INLINE pnanovdb_coord_t pnanovdb_coord_to_sort_key(pnanovdb_coord_t ijk)
{
    ...
    key.x = (ijk.z & 7) | ((ijk.y & 7) << 3) | ((ijk.x & 7) << 6) | (((ijk.z >> 3) & 15) << 9) |
            (((ijk.y >> 3) & 15) << 13) | (((ijk.x >> 3) & 15) << 17) | (((ijk.z >> 7) & 31) << 21) |
            (((ijk.y >> 7) & 31) << 26) | (((ijk.x >> 7) & 31) << 31);
    key.y = (((ijk.x >> 7) & 31) >> 1) | (((ijk.z >> 12) & 0x000FFFFF) << 4) | (((ijk.y >> 12) & 0x000FFFFF) << 24);
    key.z = (((ijk.y >> 12) & 0x000FFFFF) >> 8) | (((ijk.x >> 12) & 0x000FFFFF) << 12);
    return key;
}
...
PNANOVDB_FORCE_INLINE pnanovdb_coord_t pnanovdb_sort_key_to_coord(pnanovdb_coord_t key)
{
    ...
    // leaf[0, 9) lower[9 to 21) upper[21 to 36) root[36 to 96)
    ijk.z = (key.x & 7) | (((key.x >> 9) & 15) << 3) | (((key.x >> 21) & 31) << 7) | (((key.y >> 4) & 0x000FFFFF) << 12);
    ijk.y = ((key.x >> 3) & 7) | (((key.x >> 13) & 15) << 3) | (((key.x >> 26) & 31) << 7) |
            (((key.y >> 24) & 0x000000FF) << 12) | (((key.z << 8) & 0x000FFF00) << 12);
    ijk.x = ((key.x >> 6) & 7) | (((key.x >> 17) & 15) << 3) | (((key.x >> 31) & 1) << 7) | (((key.y << 1) & 30) << 7) |
...
PNANOVDB_FORCE_INLINE pnanovdb_address_t pnanovdb_raster_fanout_compute_tmp_size(pnanovdb_uint32_t bbox_count)
{
    ...
    pnanovdb_address_t tmp_scan_addr =
        pnanovdb_alloc_address_aligned(PNANOVDB_REF(tmp_addr), pnanovdb_scan_compute_tmp_size(bbox_count));
...
PNANOVDB_FORCE_INLINE void pnanovdb_raster_fanout_init(PNANOVDB_INOUT(pnanovdb_raster_fanout_state_t) state,
                                                       pnanovdb_uint32_t vidx_offset,
                                                       pnanovdb_buf_t smem_buf,
                                                       pnanovdb_address_t smem_addr,
                                                       pnanovdb_address_t smem_sync_addr,
                                                       PNANOVDB_INOUT(pnanovdb_sync_state_t) sync_state,
                                                       pnanovdb_buf_t sync_buf,
                                                       pnanovdb_address_t sync_addr,
                                                       pnanovdb_uint32_t bbox_count,
                                                       pnanovdb_buf_t bbox_buf,
                                                       pnanovdb_address_t bbox_addr, // 6u * bbox_count * 4u bytes
                                                       pnanovdb_buf_t tmp_buf,
                                                       pnanovdb_address_t tmp_addr)
{
    ...
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
        {
            ...
            if (bbox_idx < bbox_count && ijk_min.x <= ijk_max.x && ijk_min.y <= ijk_max.y && ijk_min.z <= ijk_max.z)
            {
                ...
                voxel_count = (ijk_max.x + 1 - ijk_min.x) * (ijk_max.y + 1 - ijk_min.y) * (ijk_max.z + 1 - ijk_min.z);
            }
    ...
    pnanovdb_scan(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, bbox_count,
                  tmp_buf, tmp_voxel_count_addr, tmp_buf, tmp_scan_addr, tmp_buf, tmp_voxel_scan_addr,
...
PNANOVDB_FORCE_INLINE pnanovdb_bool_t pnanovdb_raster_fanout_update(PNANOVDB_INOUT(pnanovdb_raster_fanout_state_t) state,
                                                                    pnanovdb_uint32_t vidx_offset,
                                                                    pnanovdb_buf_t smem_buf,
                                                                    pnanovdb_address_t smem_addr,
                                                                    pnanovdb_address_t smem_sync_addr,
                                                                    ...
                                                                    pnanovdb_buf_t tmp_buf,
                                                                    pnanovdb_address_t tmp_addr,
                                                                    pnanovdb_buf_t out_bbox_idx_buf,
                                                                    pnanovdb_address_t out_bbox_idx_addr,
                                                                    pnanovdb_buf_t out_sub_idx_buf,
                                                                    pnanovdb_address_t out_sub_idx_addr)
{
    pnanovdb_uint32_t workgroup_count = (bbox_count + 255u) / 256u;
    ...
    pnanovdb_scan_max(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, bbox_count,
                      tmp_buf, tmp_scatter_addr, tmp_buf, tmp_scan_addr, tmp_buf, out_bbox_idx_addr,
...
PNANOVDB_FORCE_INLINE pnanovdb_address_t pnanovdb_raster_and_reduce_compute_tmp_size(pnanovdb_uint32_t bbox_count,
                                                                                     pnanovdb_uint32_t key_max_count)
{
    pnanovdb_address_t tmp_addr = pnanovdb_address_null();
    pnanovdb_address_t tmp_raster_fanout_addr =
        pnanovdb_alloc_address_aligned(PNANOVDB_REF(tmp_addr), pnanovdb_raster_fanout_compute_tmp_size(bbox_count));
    ...
    pnanovdb_address_t tmp_radix_sort_96_addr = pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(tmp_addr), pnanovdb_radix_sort_96_compute_tmp_size(bbox_count + key_max_count, 16u));
    pnanovdb_address_t tmp_compact_mask_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), (bbox_count + key_max_count) * 4u);
    pnanovdb_address_t tmp_compact_key_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), (bbox_count + key_max_count) * 4u);
    pnanovdb_address_t tmp_scan_keyed_addr = pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(tmp_addr), pnanovdb_scan_keyed_float_compute_tmp_size(bbox_count + key_max_count, 4u));
    pnanovdb_address_t tmp_scan_addr = pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(tmp_addr), pnanovdb_scan_compute_tmp_size(bbox_count + key_max_count));
    pnanovdb_address_t tmp_val4_scan_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), 4u * (bbox_count + key_max_count) * 4u);
    pnanovdb_address_t tmp_key_copy_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), 3u * (bbox_count + key_max_count) * 4u);
    return tmp_addr;
}

PNANOVDB_FORCE_INLINE void pnanovdb_raster_and_reduce(pnanovdb_uint32_t vidx_offset,
                                                      pnanovdb_buf_t smem_buf,
                                                      pnanovdb_address_t smem_addr,
                                                      pnanovdb_address_t smem_sync_addr,
                                                      PNANOVDB_INOUT(pnanovdb_sync_state_t) sync_state,
...
)
{
    ...
    pnanovdb_address_t tmp_scan_addr = pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(tmp_addr), pnanovdb_scan_compute_tmp_size(bbox_count + key_max_count));
    pnanovdb_address_t tmp_scan_result_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), (bbox_count + key_max_count) * 4u);
    pnanovdb_address_t tmp_val4_scan_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), 4u * (bbox_count + key_max_count) * 4u);
    pnanovdb_address_t tmp_key_copy_addr =
    ...
    pnanovdb_raster_fanout_init(PNANOVDB_REF(fanout_state), vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state,
                                sync_buf, sync_addr, bbox_count, bbox_buf, bbox_addr, tmp_buf, tmp_raster_fanout_addr);
    ...
    {
        work_available =
            pnanovdb_raster_fanout_update(PNANOVDB_REF(fanout_state), vidx_offset, smem_buf, smem_addr, smem_sync_addr,
                                          sync_state, sync_buf, sync_addr, bbox_count, tmp_buf, tmp_raster_fanout_addr,
                                          tmp_buf, tmp_bbox_idx_addr, tmp_buf, tmp_sub_idx_addr);
        ...
        pnanovdb_uint32_t merged_count =
            pnanovdb_read_uint32(out_key_count_buf, out_key_count_addr) + fanout_state.active_count;
        ...
        // radix sort 96-bit
        pnanovdb_radix_sort_96(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr,
                               merged_count, 16u, out_key_buf, out_key_addr, out_val4_buf, out_val4_addr, tmp_buf,
                               tmp_radix_sort_96_addr);
        ...
        pnanovdb_scan(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, merged_count,
                      tmp_buf, tmp_compact_mask_addr, tmp_buf, tmp_scan_addr, tmp_buf, tmp_compact_key_addr,
                      PNANOVDB_REF(compacted_count));

        // keyed scan to merge values with matching keys
        pnanovdb_scan_keyed_float(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr,
                                  merged_count, 4u, out_val4_buf, out_val4_addr, tmp_buf, tmp_compact_key_addr, tmp_buf,
                                  tmp_scan_keyed_addr, tmp_buf, tmp_val4_scan_addr);
        ...
        pnanovdb_scan(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, merged_count,
                      tmp_buf, tmp_compact_mask_addr, tmp_buf, tmp_scan_addr, tmp_buf, tmp_scan_result_addr,
                      PNANOVDB_REF(compacted_count));
        ...
        while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
        {
            ...
            for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
            {
                ...
                if (work_idx < merged_count)
                {
                    ...
                    if (compact_mask != 0u)
                    {
                        pnanovdb_uint32_t compact_scan =
                            pnanovdb_read_uint32_index(tmp_buf, tmp_scan_result_addr, work_idx);
...
PNANOVDB_FORCE_INLINE pnanovdb_address_t pnanovdb_build_from_sorted_keys_compute_tmp_size(pnanovdb_uint32_t key_count)
{
    pnanovdb_address_t tmp_addr = pnanovdb_address_null();
    pnanovdb_address_t tmp_scan_addr =
        pnanovdb_alloc_address_aligned(PNANOVDB_REF(tmp_addr), pnanovdb_scan_compute_tmp_size(key_count));
...
PNANOVDB_FORCE_INLINE void pnanovdb_build_from_sorted_keys(pnanovdb_uint32_t vidx_offset,
                                                           pnanovdb_buf_t smem_buf,
                                                           pnanovdb_address_t smem_addr,
                                                           pnanovdb_address_t smem_sync_addr,
                                                           PNANOVDB_INOUT(pnanovdb_sync_state_t) sync_state,
                                                           ...
                                                           pnanovdb_buf_t key_buf,
                                                           pnanovdb_address_t key_addr, // 3u * key_count * 4u bytes
                                                           pnanovdb_buf_t tmp_buf,
                                                           pnanovdb_address_t tmp_addr,
                                                           pnanovdb_buf_t out_nanovdb_buf,
                                                           pnanovdb_address_t out_nanovdb_addr)
{
    ...
    pnanovdb_address_t tmp_scan_mask_addr = pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), key_count * 4u);
    pnanovdb_address_t tmp_scan_result_addr = pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), key_count * 4u);
    pnanovdb_address_t tmp_root_tile_upper_range_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), key_count * 4u);
    pnanovdb_address_t tmp_upper_lower_range_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), key_count * 4u);
    pnanovdb_address_t tmp_lower_leaf_range_addr =
        pnanovdb_alloc_address_aligned32(PNANOVDB_REF(tmp_addr), key_count * 4u);
    ...
    pnanovdb_scan(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, key_count, tmp_buf,
                  tmp_scan_mask_addr, tmp_buf, tmp_scan_addr, tmp_buf, tmp_scan_result_addr, PNANOVDB_REF(leaf_count));
    ...
    pnanovdb_scan(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, leaf_count, tmp_buf,
                  tmp_scan_mask_addr, tmp_buf, tmp_scan_addr, tmp_buf, tmp_scan_result_addr, PNANOVDB_REF(lower_count));
    // scatter to form lists
    pnanovdb_sync_set_workgroup_count(sync_state, leaf_workgroup_count);
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
        {
            ...
            if (leaf_idx < leaf_count)
            {
                ...
                if (mask != 0u)
                {
                    pnanovdb_uint32_t dst_idx =
                        pnanovdb_read_uint32_index(tmp_buf, tmp_scan_result_addr, leaf_idx) - mask;
    ...
    pnanovdb_scan(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, lower_count, tmp_buf,
                  tmp_scan_mask_addr, tmp_buf, tmp_scan_addr, tmp_buf, tmp_scan_result_addr, PNANOVDB_REF(upper_count));
    // scatter to form lists
    pnanovdb_sync_set_workgroup_count(sync_state, lower_workgroup_count);
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
        {
            ...
            if (lower_idx < lower_count)
            {
                ...
                {
                    pnanovdb_uint32_t dst_idx =
                        pnanovdb_read_uint32_index(tmp_buf, tmp_scan_result_addr, lower_idx) - mask;
    ...
    pnanovdb_scan(vidx_offset, smem_buf, smem_addr, smem_sync_addr, sync_state, sync_buf, sync_addr, upper_count,
                  tmp_buf, tmp_scan_mask_addr, tmp_buf, tmp_scan_addr, tmp_buf, tmp_scan_result_addr,
    ...
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
        {
            ...
            if (upper_idx < upper_count)
            {
                ...
                {
                    pnanovdb_uint32_t dst_idx =
                        pnanovdb_read_uint32_index(tmp_buf, tmp_scan_result_addr, upper_idx) - mask;
    ...
    pnanovdb_root_handle_t root = { pnanovdb_alloc_address_aligned32(
        PNANOVDB_REF(alloc_addr), PNANOVDB_GRID_TYPE_GET(grid_type, root_size)) };

    pnanovdb_root_tile_handle_t first_root_tile = { pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(alloc_addr),
        pnanovdb_address_offset_product(
            pnanovdb_address_null(), PNANOVDB_GRID_TYPE_GET(grid_type, root_tile_size), root_tile_count)) };
    pnanovdb_upper_handle_t first_upper = { pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(alloc_addr),
        pnanovdb_address_offset_product(
            pnanovdb_address_null(), PNANOVDB_GRID_TYPE_GET(grid_type, upper_size), upper_count)) };
    pnanovdb_lower_handle_t first_lower = { pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(alloc_addr),
        pnanovdb_address_offset_product(
            pnanovdb_address_null(), PNANOVDB_GRID_TYPE_GET(grid_type, lower_size), lower_count)) };
    pnanovdb_leaf_handle_t first_leaf = { pnanovdb_alloc_address_aligned(
        PNANOVDB_REF(alloc_addr),
        pnanovdb_address_offset_product(
            pnanovdb_address_null(), PNANOVDB_GRID_TYPE_GET(grid_type, leaf_size), leaf_count)) };
    ...
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        pnanovdb_leaf_handle_t leaf = { pnanovdb_address_offset_product(
            first_leaf.address, leaf_idx, PNANOVDB_GRID_TYPE_GET(grid_type, leaf_size)) };
        ...
        for (pnanovdb_uint32_t key_idx_base = key_begin_idx; key_idx_base < key_end_idx; key_idx_base += 256u)
        {
            ...
            pnanovdb_workgroup_reduce_and_write_mask(
                vidx_offset, smem_buf, smem_addr, write_word_idx, write_word_mask, out_nanovdb_buf,
                pnanovdb_address_offset(leaf.address, PNANOVDB_LEAF_OFF_VALUE_MASK));
        }
        pnanovdb_workgroup_reduce_min_coord(vidx_offset, smem_buf, smem_addr, ijk_min, PNANOVDB_REF(ijk_min));
        pnanovdb_workgroup_reduce_max_coord(vidx_offset, smem_buf, smem_addr, ijk_max, PNANOVDB_REF(ijk_max));
        if (vidx_offset == 0u)
        {
            pnanovdb_leaf_set_bbox_min(out_nanovdb_buf, leaf, PNANOVDB_REF(ijk_min));
            pnanovdb_uint32_t dif_and_flags = pnanovdb_int32_as_uint32((ijk_max.x - ijk_min.x) & 255) |
    ...
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        pnanovdb_lower_handle_t lower = { pnanovdb_address_offset_product(
            first_lower.address, lower_idx, PNANOVDB_GRID_TYPE_GET(grid_type, lower_size)) };
        pnanovdb_coord_t ijk_min = { PNANOVDB_INT_MAX, PNANOVDB_INT_MAX, PNANOVDB_INT_MAX };
        pnanovdb_coord_t ijk_max = { PNANOVDB_INT_MIN, PNANOVDB_INT_MIN, PNANOVDB_INT_MIN };
        for (pnanovdb_uint32_t leaf_idx_base = leaf_begin_idx; leaf_idx_base < leaf_end_idx; leaf_idx_base += 256u)
        {
            ...
            pnanovdb_workgroup_reduce_and_write_mask(
                vidx_offset, smem_buf, smem_addr, write_word_idx, write_word_mask, out_nanovdb_buf,
                pnanovdb_address_offset(lower.address, PNANOVDB_LOWER_OFF_VALUE_MASK));
            pnanovdb_workgroup_reduce_and_write_mask(
                vidx_offset, smem_buf, smem_addr, write_word_idx, write_word_mask, out_nanovdb_buf,
                pnanovdb_address_offset(lower.address, PNANOVDB_LOWER_OFF_CHILD_MASK));
        }
        pnanovdb_workgroup_reduce_min_coord(vidx_offset, smem_buf, smem_addr, ijk_min, PNANOVDB_REF(ijk_min));
        pnanovdb_workgroup_reduce_max_coord(vidx_offset, smem_buf, smem_addr, ijk_max, PNANOVDB_REF(ijk_max));
        if (vidx_offset == 0u)
    ...
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        pnanovdb_upper_handle_t upper = { pnanovdb_address_offset_product(
            first_upper.address, upper_idx, PNANOVDB_GRID_TYPE_GET(grid_type, upper_size)) };
        pnanovdb_coord_t ijk_min = { PNANOVDB_INT_MAX, PNANOVDB_INT_MAX, PNANOVDB_INT_MAX };
        pnanovdb_coord_t ijk_max = { PNANOVDB_INT_MIN, PNANOVDB_INT_MIN, PNANOVDB_INT_MIN };
        for (pnanovdb_uint32_t lower_idx_base = lower_begin_idx; lower_idx_base < lower_end_idx; lower_idx_base += 256u)
        {
            ...
            for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
            {
                ...
                {
                    pnanovdb_uint32_t leaf_idx =
                        pnanovdb_read_uint32_index(tmp_buf, tmp_lower_leaf_range_addr, lower_idx);
                    pnanovdb_uint32_t key_idx = pnanovdb_read_uint32_index(tmp_buf, tmp_leaf_key_range_addr, leaf_idx);
            ...
            pnanovdb_workgroup_reduce_and_write_mask(
                vidx_offset, smem_buf, smem_addr, write_word_idx, write_word_mask, out_nanovdb_buf,
                pnanovdb_address_offset(upper.address, PNANOVDB_UPPER_OFF_VALUE_MASK));
            pnanovdb_workgroup_reduce_and_write_mask(
                vidx_offset, smem_buf, smem_addr, write_word_idx, write_word_mask, out_nanovdb_buf,
                pnanovdb_address_offset(upper.address, PNANOVDB_UPPER_OFF_CHILD_MASK));
        }
        pnanovdb_workgroup_reduce_min_coord(vidx_offset, smem_buf, smem_addr, ijk_min, PNANOVDB_REF(ijk_min));
        pnanovdb_workgroup_reduce_max_coord(vidx_offset, smem_buf, smem_addr, ijk_max, PNANOVDB_REF(ijk_max));
        if (vidx_offset == 0u)
    ...
    while (pnanovdb_sync_get_workgroup_idx(sync_state, smem_buf, smem_sync_addr, sync_buf, sync_addr))
    {
        ...
        for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
        {
            ...
            {
                pnanovdb_uint32_t upper_begin_idx =
                    pnanovdb_read_uint32_index(tmp_buf, tmp_root_tile_upper_range_addr, root_tile_idx);
                pnanovdb_uint32_t upper_end_idx = upper_count;
                if (root_tile_idx + 1u < root_tile_count)
                {
                    upper_end_idx =
                        pnanovdb_read_uint32_index(tmp_buf, tmp_root_tile_upper_range_addr, root_tile_idx + 1u);
                }
                pnanovdb_root_tile_handle_t root_tile = { pnanovdb_address_offset_product(
                    first_root_tile.address, root_tile_idx, PNANOVDB_GRID_TYPE_GET(grid_type, root_tile_size)) };
                for (pnanovdb_uint32_t upper_idx = upper_begin_idx; upper_idx < upper_end_idx; upper_idx++)
                {
                    pnanovdb_uint32_t lower_idx =
                        pnanovdb_read_uint32_index(tmp_buf, tmp_upper_lower_range_addr, upper_idx);
                    pnanovdb_uint32_t leaf_idx =
                        pnanovdb_read_uint32_index(tmp_buf, tmp_lower_leaf_range_addr, lower_idx);
                    pnanovdb_uint32_t key_idx = pnanovdb_read_uint32_index(tmp_buf, tmp_leaf_key_range_addr, leaf_idx);
        ...
        for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
        {
            ...
            if (thread_idx == 32)
            {
                ...
                pnanovdb_uint64_t grid_size =
                    pnanovdb_int64_as_uint64(pnanovdb_address_diff(alloc_addr, pnanovdb_address_null()));
            ...
            if (thread_idx == 64)
            {
                pnanovdb_vec3_t voxel_size_inv = { 1.f / voxel_size.x, 1.f / voxel_size.y, 1.f / voxel_size.z };
