...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_atomic_add_uint32(pnanovdb_buf_t buf,
...
{
    pnanovdb_coord_t ret = { pnanovdb_int32_max(a.x, b.x), pnanovdb_int32_max(a.y, b.y), pnanovdb_int32_max(a.z, b.z) };
    return ret;
}
PNANOVDB_FORCE_INLINE pnanovdb_coord_t pnanovdb_coord_min(pnanovdb_coord_t a, pnanovdb_coord_t b)
{
    pnanovdb_coord_t ret = { pnanovdb_int32_min(a.x, b.x), pnanovdb_int32_min(a.y, b.y), pnanovdb_int32_min(a.z, b.z) };
    return ret;
}
...
PNANOVDB_FORCE_INLINE pnanovdb_uint32_t pnanovdb_read_uint32_index(pnanovdb_buf_t buf,
...
PNANOVDB_FORCE_INLINE void pnanovdb_write_uint32_index(pnanovdb_buf_t buf,
                                                       pnanovdb_address_t addr,
                                                       pnanovdb_uint32_t index,
...
PNANOVDB_FORCE_INLINE pnanovdb_int32_t pnanovdb_read_int32_index(pnanovdb_buf_t buf,
                                                                 pnanovdb_address_t addr,
                                                                 pnanovdb_uint32_t index)
{
    return pnanovdb_read_int32(buf, pnanovdb_address_offset_product(addr, index, 4u));
}
PNANOVDB_FORCE_INLINE void pnanovdb_write_int32_index(pnanovdb_buf_t buf,
                                                      pnanovdb_address_t addr,
                                                      pnanovdb_uint32_t index,
                                                      pnanovdb_int32_t val)
{
...
PNANOVDB_FORCE_INLINE void pnanovdb_write_float_index(pnanovdb_buf_t buf,
                                                      pnanovdb_address_t addr,
                                                      pnanovdb_uint32_t index,
                                                      float val)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_uvec4_t pnanovdb_read_uvec4_index(pnanovdb_buf_t buf,
                                                                 pnanovdb_address_t addr,
                                                                 pnanovdb_uint32_t index)
{
...
PNANOVDB_FORCE_INLINE void pnanovdb_write_uvec4_index(pnanovdb_buf_t buf,
                                                      pnanovdb_address_t addr,
                                                      pnanovdb_uint32_t index,
                                                      pnanovdb_uvec4_t val)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_vec4_t pnanovdb_read_vec4_index(pnanovdb_buf_t buf,
                                                               pnanovdb_address_t addr,
                                                               pnanovdb_uint32_t index)
{
...
PNANOVDB_FORCE_INLINE void pnanovdb_write_vec4_index(pnanovdb_buf_t buf,
                                                     pnanovdb_address_t addr,
                                                     pnanovdb_uint32_t index,
                                                     pnanovdb_vec4_t val)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_coord_t pnanovdb_read_coord_index(pnanovdb_buf_t buf,
                                                                 pnanovdb_address_t addr,
                                                                 pnanovdb_uint32_t index)
{
...
PNANOVDB_FORCE_INLINE void pnanovdb_write_coord_index(pnanovdb_buf_t buf,
                                                      pnanovdb_address_t addr,
                                                      pnanovdb_uint32_t index,
                                                      PNANOVDB_INOUT(pnanovdb_coord_t) val)
{
    pnanovdb_write_coord(buf, pnanovdb_address_offset_product(addr, index, 12u), val);
}

PNANOVDB_FORCE_INLINE pnanovdb_address_t pnanovdb_alloc_address_aligned(PNANOVDB_INOUT(pnanovdb_address_t) alloc_addr,
                                                                        pnanovdb_address_t alloc_size)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_address_t pnanovdb_alloc_address_aligned32(PNANOVDB_INOUT(pnanovdb_address_t) alloc_addr,
                                                                          pnanovdb_uint32_t alloc_size)
{
    pnanovdb_address_t ret;
    ret.byte_offset = PNANOVDB_DEREF(alloc_addr).byte_offset;
...
PNANOVDB_FORCE_INLINE pnanovdb_bool_t pnanovdb_sync_init(PNANOVDB_INOUT(pnanovdb_sync_state_t) state,
                                                         pnanovdb_uint32_t vidx_offset,
                                                         pnanovdb_uint32_t workgroup_count,
                                                         pnanovdb_buf_t workgroup_status_buf,
                                                         pnanovdb_address_t workgroup_status_addr)
{
...
PNANOVDB_FORCE_INLINE pnanovdb_bool_t pnanovdb_sync_get_workgroup_idx(PNANOVDB_INOUT(pnanovdb_sync_state_t) state,
                                                                      ...
                                                                      pnanovdb_address_t sync_addr)
{
    ...
    if (PNANOVDB_DEREF(state).attempt_idx > PNANOVDB_DEREF(state).workgroup_count + 1) // + 1 to make sure last task
                                                                                       // gets reported complete
    {
        return false;
    }
    ...
    if (PNANOVDB_DEREF(state).vidx_offset == 0u)
    {
        ...
        {
            pnanovdb_atomic_add_uint32(
                sync_buf, pnanovdb_address_offset(sync_addr, (2u * PNANOVDB_DEREF(state).dispatch_idx + 1u) * 4u), 1u);
        }

        // get new work
        PNANOVDB_DEREF(state).workgroup_idx = pnanovdb_atomic_add_uint32(
            sync_buf, pnanovdb_address_offset(sync_addr, (2u * PNANOVDB_DEREF(state).dispatch_idx + 0u) * 4u), 1u);
...
PNANOVDB_FORCE_INLINE void pnanovdb_sync(PNANOVDB_INOUT(pnanovdb_sync_state_t) state,
                                         ...
                                         pnanovdb_address_t sync_addr)
{
    ...
    while (0u == pnanovdb_read_uint32(smem_buf, s_is_finished_addr))
    {
        if (PNANOVDB_DEREF(state).vidx_offset == 0u)
        {
            ...
            oldValue = pnanovdb_atomic_add_uint32(
                sync_buf, pnanovdb_address_offset(sync_addr, (2u * PNANOVDB_DEREF(state).dispatch_idx + 1u) * 4u), 0u);
...
PNANOVDB_FORCE_INLINE void pnanovdb_sync_set_workgroup_count(PNANOVDB_INOUT(pnanovdb_sync_state_t) state,
                                                             pnanovdb_uint32_t new_workgroup_count)
{
    PNANOVDB_DEREF(state).workgroup_count = new_workgroup_count;
}

PNANOVDB_FORCE_INLINE void pnanovdb_sync_final(PNANOVDB_INOUT(pnanovdb_sync_state_t) state,
                                               pnanovdb_buf_t workgroup_status_buf,
                                               pnanovdb_address_t workgroup_status_addr)
{
    pnanovdb_workgroup_sync();
