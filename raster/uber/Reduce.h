...
PNANOVDB_FORCE_INLINE void pnanovdb_workgroup_reduce(pnanovdb_uint32_t vidx_offset,
                                                     ...
                                                     PNANOVDB_INOUT(pnanovdb_uint32_t) total_count)
{
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        localVal[vidx] = val[vidx].x + val[vidx].y + val[vidx].z + val[vidx].w;
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        PNANOVDB_DEREF(total_count) =
            pnanovdb_read_uint32_index(smem_buf, sdata1_addr, 0) + pnanovdb_read_uint32_index(smem_buf, sdata1_addr, 1) +
            pnanovdb_read_uint32_index(smem_buf, sdata1_addr, 2) + pnanovdb_read_uint32_index(smem_buf, sdata1_addr, 3);
    }
}
...
PNANOVDB_FORCE_INLINE void pnanovdb_workgroup_reduce_float(pnanovdb_uint32_t vidx_offset,
                                                           pnanovdb_buf_t smem_buf,
                                                           pnanovdb_address_t smem_addr,
                                                           ...
                                                           PNANOVDB_INOUT(float) total_count)
{
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        // compute totalCount
        PNANOVDB_DEREF(total_count) =
            pnanovdb_read_float_index(smem_buf, sdata1_addr, 0) + pnanovdb_read_float_index(smem_buf, sdata1_addr, 1) +
            pnanovdb_read_float_index(smem_buf, sdata1_addr, 2) + pnanovdb_read_float_index(smem_buf, sdata1_addr, 3);
    }
}
...
PNANOVDB_FORCE_INLINE void pnanovdb_workgroup_reduce_max(pnanovdb_uint32_t vidx_offset,
                                                         pnanovdb_buf_t smem_buf,
                                                         pnanovdb_address_t smem_addr,
                                                         pnanovdb_uvec4_t val[PNANOVDB_COMPUTE_VECTOR_WIDTH],
                                                         PNANOVDB_INOUT(pnanovdb_uint32_t) total_max)
{
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_uint32_max(localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata0_addr, thread_idx + 64u));
            localVal[vidx] = pnanovdb_uint32_max(
                localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata0_addr, thread_idx + 128u));
            localVal[vidx] = pnanovdb_uint32_max(
                localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata0_addr, thread_idx + 192u));
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_uint32_max(localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata1_addr, thread_idx + 16u));
            localVal[vidx] =
                pnanovdb_uint32_max(localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata1_addr, thread_idx + 32u));
            localVal[vidx] =
                pnanovdb_uint32_max(localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata1_addr, thread_idx + 48u));
            pnanovdb_write_uint32_index(smem_buf, sdata0_addr, thread_idx, localVal[vidx]);
        }
    }
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_uint32_max(localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata0_addr, thread_idx + 4u));
            localVal[vidx] =
                pnanovdb_uint32_max(localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata0_addr, thread_idx + 8u));
            localVal[vidx] =
                pnanovdb_uint32_max(localVal[vidx], pnanovdb_read_uint32_index(smem_buf, sdata0_addr, thread_idx + 12u));
            pnanovdb_write_uint32_index(smem_buf, sdata1_addr, thread_idx, localVal[vidx]);
        }
    }
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        // compute totalCount
        PNANOVDB_DEREF(total_max) =
            pnanovdb_uint32_max(pnanovdb_uint32_max(pnanovdb_read_uint32_index(smem_buf, sdata1_addr, 0),
                                                    pnanovdb_read_uint32_index(smem_buf, sdata1_addr, 1)),
                                pnanovdb_uint32_max(pnanovdb_read_uint32_index(smem_buf, sdata1_addr, 2),
...
PNANOVDB_FORCE_INLINE void pnanovdb_workgroup_reduce_max_coord(pnanovdb_uint32_t vidx_offset,
                                                               pnanovdb_buf_t smem_buf,
                                                               pnanovdb_address_t smem_addr,
                                                               ...
                                                               PNANOVDB_INOUT(pnanovdb_coord_t) total_max)
{
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 64u));
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 128u));
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 192u));
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata1_addr, thread_idx + 16u));
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata1_addr, thread_idx + 32u));
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata1_addr, thread_idx + 48u));
            pnanovdb_write_coord_index(smem_buf, sdata0_addr, thread_idx, PNANOVDB_REF(localVal[vidx]));
        }
    }
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 4u));
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 8u));
            localVal[vidx] =
                pnanovdb_coord_max(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 12u));
            pnanovdb_write_coord_index(smem_buf, sdata1_addr, thread_idx, PNANOVDB_REF(localVal[vidx]));
        }
    }
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        // compute totalCount
        PNANOVDB_DEREF(total_max) =
            pnanovdb_coord_max(pnanovdb_coord_max(pnanovdb_read_coord_index(smem_buf, sdata1_addr, 0),
                                                  pnanovdb_read_coord_index(smem_buf, sdata1_addr, 1)),
                               pnanovdb_coord_max(pnanovdb_read_coord_index(smem_buf, sdata1_addr, 2),
...
PNANOVDB_FORCE_INLINE void pnanovdb_workgroup_reduce_min_coord(pnanovdb_uint32_t vidx_offset,
                                                               pnanovdb_buf_t smem_buf,
                                                               pnanovdb_address_t smem_addr,
                                                               pnanovdb_coord_t val,
                                                               PNANOVDB_INOUT(pnanovdb_coord_t) total_min)
{
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 64u));
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 128u));
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 192u));
            pnanovdb_write_coord_index(smem_buf, sdata1_addr, thread_idx, PNANOVDB_REF(localVal[vidx]));
        }
    }
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata1_addr, thread_idx + 16u));
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata1_addr, thread_idx + 32u));
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata1_addr, thread_idx + 48u));
            pnanovdb_write_coord_index(smem_buf, sdata0_addr, thread_idx, PNANOVDB_REF(localVal[vidx]));
        }
    }
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        {
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 4u));
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 8u));
            localVal[vidx] =
                pnanovdb_coord_min(localVal[vidx], pnanovdb_read_coord_index(smem_buf, sdata0_addr, thread_idx + 12u));
            pnanovdb_write_coord_index(smem_buf, sdata1_addr, thread_idx, PNANOVDB_REF(localVal[vidx]));
        }
    }
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        // compute totalCount
        PNANOVDB_DEREF(total_min) =
            pnanovdb_coord_min(pnanovdb_coord_min(pnanovdb_read_coord_index(smem_buf, sdata1_addr, 0),
                                                  pnanovdb_read_coord_index(smem_buf, sdata1_addr, 1)),
                               pnanovdb_coord_min(pnanovdb_read_coord_index(smem_buf, sdata1_addr, 2),
                                                  pnanovdb_read_coord_index(smem_buf, sdata1_addr, 3)));
    }
}
    ...
    pnanovdb_address_t dst_addr)
{
    ...
    for (vidx = 0u; vidx < PNANOVDB_COMPUTE_VECTOR_WIDTH; vidx++)
    {
        ...
        if (is_unique)
        {
            ...
            {
                pnanovdb_uint32_t cmp_word_idx =
                    pnanovdb_read_uint32_index(smem_buf, s_word_idx_addr, thread_idx + bit_idx);
