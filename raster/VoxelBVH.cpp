...
void nanovdb_rgba8_integral_from_voxelbvh(const pnanovdb_compute_t* compute,
                                          pnanovdb_compute_queue_t* queue,
                                          pnanovdb_voxelbvh_context_t* voxelbvh_context,
                                          pnanovdb_compute_buffer_t* dst_nanovdb_inout,
                                          pnanovdb_uint64_t dst_nanovdb_word_count,
...
pnanovdb_voxelbvh_t* pnanovdb_get_voxelbvh()
{
    ...
    iface.nanovdb_rgba8_integral_from_voxelbvh = nanovdb_rgba8_integral_from_voxelbvh;
    iface.nanovdb_rgba8_integral_from_voxelbvh_array = nanovdb_rgba8_integral_from_voxelbvh_array;
