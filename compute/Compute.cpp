                                                 ...
                                                 pnanovdb_compute_buffer_transient_t** readback_buffer)
{
    ...
    compute->dispatch_shader(compute_interface, compute_context, shader_context, resources.data(),
                             (image_width + 31u) / 32u, (image_height + 3u) / 4u, 1u, "dispatch_shader_on_nanovdb_array");
