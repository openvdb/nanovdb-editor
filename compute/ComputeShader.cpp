...
/*!
    \file   nanovdb_editor/compute/ComputeShader.cpp
...
pnanovdb_compute_shader_t* copy_shader(const pnanovdb_shader::ShaderData* shader)
{
    ...
    computeShader->build =
        pnanovdb_compute_shader_build_t({ pipelineDesc, descriptor_writes, resource_names, descriptor_write_count, "" });
...
pnanovdb_compute_shader_interface_t* pnanovdb_get_compute_shader_interface()
{
    ...
    static pnanovdb_compute_shader_interface_t iface = { PNANOVDB_REFLECT_INTERFACE_INIT(
