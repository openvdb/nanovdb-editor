...
# On Windows, use import libraries (.lib) instead of DLLs for linking
if(WIN32)
  set(_SHARED_SUFFIX "${CMAKE_IMPORT_LIBRARY_SUFFIX}")
  set(_SHARED_PREFIX "${CMAKE_IMPORT_LIBRARY_PREFIX}")
else()
