...
if(LINK_KIND STREQUAL "directory")
    if(IS_DIRECTORY "${TARGET_PATH_NORMALIZED}" OR EXISTS "${TARGET_PATH_NORMALIZED}")
        set(TARGET_EXISTS TRUE)
    endif()
elseif(LINK_KIND STREQUAL "file")
    if(EXISTS "${TARGET_PATH_NORMALIZED}")
        set(TARGET_EXISTS TRUE)
    endif()
endif()

if(LINK_KIND STREQUAL "file" AND TARGET_EXISTS)
    execute_process(
...
elseif(NOT TARGET_EXISTS)
    ...
    if(LINK_KIND STREQUAL "file")
        ...
        if(NOT LINK_RESULT EQUAL 0 AND NOT TARGET_EXISTS)
            execute_process(
                COMMAND "${CMAKE_COMMAND}" -E copy_if_different "${SOURCE_PATH_NORMALIZED}" "${TARGET_PATH_NORMALIZED}"
                RESULT_VARIABLE COPY_RESULT
            )
