...
set(_src "")
file(GLOB _already_present "${_dst_dir}/libslang-llvm${CMAKE_SHARED_LIBRARY_SUFFIX}*")
if(_already_present)
    list(GET _already_present 0 _src)
    message(STATUS "slang_ep_install: libslang-llvm already present in ${_dst_dir}: ${_src}")
elseif(_preferred_matches)
...
elseif(NOT _already_present)
    message(STATUS "slang_ep_install: No libslang-llvm found in ${_dst_dir} or under ${_bin_dir}/slang-*/lib; proceeding")
endif()
